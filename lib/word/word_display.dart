              ...
              child: ListView(
                children: [
                  ...
                  ListTile(
                    ...
                    subtitle: Text(wordSynsets[index].synset.conceptDefinition),
                  ),
                  FutureBuilder<PartOfSpeechWithSubtype>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (snapshot.hasData) {
                        PartOfSpeechWithSubtype posWithSubtype = snapshot.data!;
                          ...
                          return Column(children: [
                            ...
                            if (ApplicationContext().showPOSKind() &&
                              ...
                              ListTile(
                                ...
                                subtitle: Text(
                                    kindOfPOSToString(posWithSubtype.kind)),
                              ),
                          ]);
                        } else {
                            ...
                            subtitle: Wrap(
                              children: synonyms.map((synonym) {
                                return ActionChip(
                                    ...
                                    onPressed: () {
                                      Get.to(() =>
                                          WordDisplay(wordSynsets: [synonym]));
                                    });
                              }).toList(),
                            ),
                          );
                            ...
                            subtitle: Wrap(
                              children: antonyms.map((antonym) {
                                return ActionChip(
                                    ...
                                    onPressed: () {
                                      Get.to(() =>
                                          WordDisplay(wordSynsets: [antonym]));
                                    });
                              }).toList(),
                            ),
                          );
                          ...
                          if (affix.affixKind != AffixKind.unspecified) {
                            return Column(
                              children: [
                                ...
                                ListTile(
                                  title:
                                      Text(affixKindToString(affix.affixKind)),
                        ...
                        if (snapshot.hasData) {
                          ...
                          if (indeclinable != Indeclinable.unspecified) {
                            return ListTile(
                              ...
                              subtitle:
                                  Text(indeclinableToString(indeclinable)),
                            );
                          } else {
                            return const SizedBox.shrink();
                          }
                        ...
                        if (snapshot.hasData) {
                          ...
                          if (transitivity != Transitivity.unspecified) {
                            return ListTile(
                              ...
                              subtitle:
                                  Text(transitivityToString(transitivity)),
                            );
                          } else {
                            return const SizedBox.shrink();
                          }
                        ...
                        if (snapshot.hasData) {
                          ...
                          if (modifiesNoun.isNotEmpty) {
                            return ListTile(
                              ...
                              subtitle: Wrap(
                                children: modifiesNoun.map((_modifiesNoun) {
                                  return ActionChip(
                                      label: Text(_modifiesNoun.word.word),
                                      onPressed: () {
                                        Get.to(() => WordDisplay(
                                              wordSynsets: [_modifiesNoun],
                                            ));
                                      });
                                }).toList(),
                              ),
